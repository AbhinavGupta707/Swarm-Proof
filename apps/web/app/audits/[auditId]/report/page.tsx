...
import { BugReportDownload } from "./bug-report-download";
        ...
        <section className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-ui border border-line bg-panel p-5">
            ...
            <div className="mt-4 grid gap-3">
              ...
              <BugReportDownload bugReport={bugReport} auditId={audit.id} issueCount={audit.issues.length} score={audit.score} />
